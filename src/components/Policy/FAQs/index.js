        ...
        <Container className='faqs-container' fluid='md'>
            ...
            <div className='faqs-content'>
                ...
                <div className='FAQ-answer'>
                    ...
                    <p>
                        Rất tiếc rằng UITBooks hiện chỉ cung cấp dịch vụ mua hàng qua kênh thương mại điện tử là website <b>UITBooks.com</b>. Chúng tôi hiện chưa có cho mình cửa hàng offline để Quý khách hàng có thể đến trực tiếp để dễ dàng chọn lựa sản phẩm.
                ...
                <div className='FAQ-answer'>
                    <QuestionAnswerOutlinedIcon />
                    <p>
                        Quý khách chỉ có thể hủy đơn hàng khi đơn hàng chưa được gọi xác nhận từ bộ phận chăm sóc khách hàng của UITBooks.com. Nếu không có nhu cầu nhận hàng, quý khách vui lòng tham khảo thêm chính sách đổi &amp; trả hàng của chúng tôi.
                    </p>
                </div>
                <h4 className='heading-title'>
